# Python rile to demonstrate handling multiple exceptions in a GUI program
...
def process_file():
    ...
    try:
        ...
        # Handle when permission errors (our program doesn't have access rights to the file)
        result_label.config(text=f"Error: Permission denied accessing '{file_name}'.")
        ...
        result_label.config(text=f"Unexpected error occurred : \nPlease try again. \n{e}")
...
# Browse button
tk.Button(entry_frame, text='Browse', command=browse_file).pack(side="left")
